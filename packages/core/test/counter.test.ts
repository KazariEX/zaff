...
describe("countAff", () => {
    it("should connect Arcs across TimingGroups", () => {
        ...
        const tg1 = Aff.timinggroup([
            Aff.timing(0, 120.00, 4.00),
            Aff.arc(1, 502, 1.00, 1.00, "s", 0.00, 0.00, 0, "none", false)
        ]);
...
describe("countTimingGroup", () => {
    ...
    it("arc", () => {
        const tg = Aff.timinggroup([
            ...
            Aff.arc(0, 499, 0.00, 0.00, "s", 0.00, 0.00, 0, "none", false), // 1
            Aff.arc(0, 501, 0.00, 0.00, "s", 0.00, 0.00, 0, "none", false), // 2
            Aff.arc(1, 1, 0.50, 1.00, "s", 0.00, 0.00, 0, "none", false),   // 0
            Aff.arc(1, 502, 1.00, 1.00, "s", 0.00, 0.00, 0, "none", false), // 3
